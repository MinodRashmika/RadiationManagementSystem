...
describe('SortBy function', () => {
    ...
    it('executes the SortBy function with different scenarios', async () => {
        // Test Case 1: Successful sort by First Name
        const TableName1 = 'LS'; // Table being called
        const ColumnName1 = 'Name (first)'; // column name
        const expectedSQL1 = 'CALL SortByName(First)_LS'; //Expected SQL response to ensure its not accessing other column
        ...
        // Test Case 2: Successful sort by Last Name
        const TableName2 = 'LS';
        const ColumnName2 = 'Name (last)'; 
        const expectedSQL2 = 'CALL SortByName(Last)_LS';
        ...
        const TableName3 = 'LS';
        const ColumnName3 = 'Email'; 
        const expectedSQL3 = 'CALL SortByEmail_LS';
        ...
        const expectedSQL4 = 'CALL SortByPhone_LS';
        ...
        const expectedSQL5 = 'CALL SortByLicenseNo_LS';
        ...
        // Test Case 6: Sort by Sequence No
        const TableName6 = 'ls';
        const ColumnName6 = 'Sequence no';
        const expectedSQL6 = 'CALL SortBySequenceNo_LS';
        ...
        const expectedSQL7 = 'CALL SortByExpiry_LS';
        ...
        const expectedSQL8 = 'CALL SortByPurposes_LS';
        ...
        // Test Case 9: Sort by Model
        const TableName9 = 'LS';
        const ColumnName9 = 'RSS';
        const expectedSQL9 = 'CALL SortByRSS_LS';
        ...
        // Test Case 10: Sort by Serial no
        const TableName10 = 'LS';
        const ColumnName10 = 'Comments';
        const expectedSQL10 = 'CALL SortByComments_LS';
...
describe('Add, Edit, and Delete Operations for LS Table', () => {
    // Test cases for adding entries to LS table
    describe('Add Operation for LS Table', () => {
        it('executes the addToTable function with different scenarios for LS table', async () => {
            // Test Case 1: Successful Insertion
            const TableName1 = 'LS';
            const Data1 = ['matthew', 'tam', '11111111@student.curtin.edu.au', '', '', '', '', '6/09/2024', '', '', ''];
            const expectedSQL1 = 'CALL AddLSEntry("matthew","tam","11111111@student.curtin.edu.au","","","","","6/09/2024","","","");';
    ...
    // Test cases for editing entries in LS table
    describe('Edit Operation for LS Table', () => {
        it('executes the editRowTable function with different scenarios for LS table', async () => {
    ...
    // Test cases for deleting entries from LS table
    describe('Delete Operation for LS Table', () => {
        it('executes the deleteFromTable function with different scenarios for LS table', async () => {
        ...
        // Test cases for Recovering entries from LS table
        describe('Recover Operation for LS Table', () => {
            it('executes the restorefromTable function with different scenarios for LS table', async () => {
