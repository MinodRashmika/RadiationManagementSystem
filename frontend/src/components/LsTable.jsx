    ...
    return(
        <div className=" w-[100vw] h-[100vh] relative">
            <div className="absolute top-0 right-0 left-0 overflow-x-auto shadow-md sm:rounded-lg max-w-max m-auto">
                ...
                <table id="LsTable" className= "w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400 overflow-x-auto">
                    ...
                    <tbody>
                            {Info.asset.filter((person) => {
                                if(searchTerm == ""){
                                    return person;
                                } else if (person['Name (first)'].toString().toLowerCase().includes(searchTerm.toLowerCase()) || 
                                person['Name (last)'].toString().toLowerCase().includes(searchTerm.toLowerCase())){
                                            return person;
                                         }
                            }).map((data,key) => {
                                return(
